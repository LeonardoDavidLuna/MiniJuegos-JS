  ...
  <head>
    ...
    <div id="container">
        ...
        <div class='subcontainer'>
	        ...
	        <img src="imagenes/gif10.gif" width="24%" draggable="false">
	        <img src="imagenes/frase10.jpg" width="60%" draggable="false">
	    </div>
	    ...
	    <div id="containerPalabra">
            ...
            <div class="Palabra" id="6"  name="i" ondrop="drop(event)" ondragover="allowDrop(event)" ondragend="end(event)">i</div>
            <div class="Palabra" id="7"  name="g" ondrop="drop(event)" ondragover="allowDrop(event)" ondragend="end(event)">g</div>
            <div class="Palabra" id="8"  name="h" ondrop="drop(event)" ondragover="allowDrop(event)" ondragend="end(event)">h</div>
            <div class="Palabra" id="9"  name="t" ondrop="drop(event)" ondragover="allowDrop(event)" ondragend="end(event)">t</div>
        ...
        <img id="btn" src="Otros/arrow_next.png" onClick="location='palabra11.php'" style='display:none;'>
